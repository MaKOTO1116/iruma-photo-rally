(function() {
	...
	*/
	...
	var IMAGES = {
		hero1: "https://images.unsplash.com/photo-1758095385645-5c46b68b4959?w=800&h=600&fit=crop&auto=format",
		hero2: "https://images.unsplash.com/photo-1669630072796-9fd58a1f90bd?w=600&h=800&fit=crop&auto=format",
		hero3: "https://images.unsplash.com/photo-1607025434171-016f24de7f9a?w=600&h=600&fit=crop&auto=format",
		waterfall: "https://images.unsplash.com/photo-1636963332329-bab1cbd03b2b?w=800&h=600&fit=crop&auto=format",
		village: "https://images.unsplash.com/photo-1623078788671-f168da577997?w=800&h=500&fit=crop&auto=format",
		satoyama: "https://images.unsplash.com/photo-1699356302651-c3354b04dd28?w=800&h=500&fit=crop&auto=format"
	};
	//#endregion
	...
	*/
	...
	//#endregion
	//#region src/components/HashtagBadge.tsx
	var import_jsx_runtime = (/* @__PURE__ */ __commonJSMin(((exports, module) => {
		module.exports = require_react_jsx_runtime_production();
	})))();
	/** ハッシュタグ「#八重滝フォトラリー」の強調バッジ */
	function HashtagBadge({ size = "md" }) {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: `inline-flex items-center gap-1 font-black rounded-full text-white ${size === "lg" ? "text-lg px-5 py-2" : size === "sm" ? "text-sm px-3 py-1" : "text-base px-4 py-1.5"}`,
			style: {
				background: "linear-gradient(135deg, #6A3DE8 0%, #3D8BFF 100%)",
				boxShadow: "0 4px 14px rgba(106,61,232,0.35)"
			},
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "#八重滝フォトラリー" })
		});
	}
	//#endregion
	//#region src/sections/Hero.tsx
	/** ファーストビュー：写真コラージュ＋キャッチコピー＋応募期間 */
	function Hero() {
	...
	//#endregion
	//#region src/components/DotBackground.tsx
	/** うっすらドット柄を敷いた背景ラッパー */
	function DotBackground({ children, className = "" }) {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: `relative dot-pattern ${className}`,
			children
		});
	}
	//#endregion
	//#region src/sections/EventIntro.tsx
	var STEPS = [
		{
			step: "01",
			emoji: "🏞️",
	...
	function EventIntro() {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DotBackground, {
	...
	//#endregion
	//#region src/components/QRPlaceholder.tsx
	/**
	* QRコードのダミー表示。
	* 本番公開時は、実際のページURLで生成したQRコード画像に差し替えてください。
	*/
	function QRPlaceholder() {
		...
		const cells = Array.from({ length: 441 }, (_, i) => {
			...
			const isFinderPattern = row < 7 && col < 7 || row < 7 && col > 13 || row > 13 && col < 7;
			const isRandom = Math.sin(i * 137.508) > .1;
			return isFinderPattern || isRandom;
		});
	...
	//#endregion
	//#region src/sections/Poster.tsx
	/** イベントポスターの掲載＋このページのQRコード */
	function Poster() {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "px-5 py-12",
			style: { background: "linear-gradient(160deg, #6A3DE8 0%, #4a6fe0 50%, #3D8BFF 100%)" },
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "max-w-md mx-auto flex flex-col gap-8",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	//#endregion
	//#region src/sections/IrumaIntro.tsx
	/** 掛合町入間の紹介セクション */
	function IrumaIntro() {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "px-5 py-12",
			style: { background: "linear-gradient(180deg, #fffbf0 0%, #fff8ee 100%)" },
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "max-w-md mx-auto flex flex-col gap-8",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	function Footer() {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
			...
			style: { background: "linear-gradient(135deg, #3a1a8a 0%, #1a3a8a 100%)" },
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	//#endregion
	//#region src/components/SectionWave.tsx
	/**
	* セクションの継ぎ目に入れる波型の飾り。
	* App.tsx 内で使っている個別デザインの波を共通化したもの。
	*/
	function SectionWave({ background, paths }) {
	...
	*
	* セクション構成:
	*   1. Hero       - ファーストビュー（写真コラージュ＋キャッチコピー）
	*   2. EventIntro - 応募の3ステップ＋ハッシュタグ強調
	*   3. Poster     - イベントポスター掲載＋このページのQRコード
	*   4. IrumaIntro - 掛合町入間の紹介
	*   5. Links      - 入間の公式HP・Instagramへのリンク
	*   6. Footer     - 主催表記
	*
